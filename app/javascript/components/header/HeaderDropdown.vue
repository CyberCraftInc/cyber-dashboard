  ...
  <div class="dropdown">
    ...
    <div class="dropdown__content" @mouseleave="mouseLeave">
      <ul class="nav navbar-nav">
        ...
        <li><a :href="editUserLink">{{ editUser }}</a></li>
        <li><a rel="nofollow" :data-method="methodLogOut" :href="logOutLink">{{ logOut }}</a></li>
      </ul>
    </div>
  </div>
</template>
...
<script>
  export default {
    methods: {
      ...
      mouseLeave: function() {
        document.querySelector('div.dropdown__header').classList.remove('is-active')
      }
    },
    data() {
      return {
